...
const { findAllDraftsForShop, publishProductByShop, queryProduct, unPublishProductByShop, searchProductsByUser, findAllProducts, findProduct } = require("../models/repositories/product.repo")
...
class ProductFactory {
  ...
  static async findProduct({ product_id }) {
    return await findProduct({ product_id, unSelect: ['__v', 'product_variantions'] });
  }
}
...
class Clothing extends Product {
  async createProduct() {
    ...
    if (!newProduct) throw new BadRequestError("Create new Prodcuct error");
    return newProduct
  }
}
